...
class TransactionSource(val name: String, val type: SourceType) {
    ...
    companion object {
        ...
        fun davinciscan(apiKeys: List<String>): TransactionSource {
            return TransactionSource(
                "https://mainnet-explorer.davinci.bz",
                SourceType.Etherscan("https://https://mainnet-explorer.davinci.bz/api", "https://mainnet-explorer.davinci.bz", apiKeys)
            )
        }
