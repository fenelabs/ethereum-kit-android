...
import io.fenelabs.ethereumkit.spv.net.les.messages.GetProofsMessage
import io.fenelabs.ethereumkit.spv.net.les.messages.ProofsMessage
...
class AccountStateTaskHandler(private var listener: Listener? = null) : ITaskHandler, IMessageHandler {
    ...
    private fun parse(proofsMessage: ProofsMessage, task: AccountStateTask): AccountStateSpv {
        ...
        check(lastNode.nodeType == io.fenelabs.ethereumkit.spv.net.les.TrieNode.NodeType.LEAF) {
